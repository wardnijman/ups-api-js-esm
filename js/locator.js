...
export const LocatorAPI = superclass => class extends superclass {
    /**
    ...
    async getNearestAccessPoint(addressLine, city, postalCode, countryCode, options = {}) {
        ...
        const payload = this._buildNearestAccessPointPayload(addressLine, city, postalCode, countryCode, options);
    ...
    _buildNearestAccessPointPayload(addressLine, city, postalCode, countryCode, { consignee = null, locale = "en_US", metric = true, radius = 150 } = {}) {
        const payload = {
            LocatorRequest: {
                Request: {
