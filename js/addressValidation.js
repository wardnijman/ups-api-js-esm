...
export const AddressValidationApi = superclass => class extends superclass {
    /**
    ...
    async addressValidation(requestoption, address, options = {}) {
        ...
        const payload = this._buildAddressValidationPayload(consigneeName, attentionName, addressLine, addressLine2, city, postalCode, stateCode, countryCode);
    ...
    _buildAddressValidationPayload(consigneeName, attentionName, addressLine, addressLine2, city, postalCode, stateCode, countryCode) {
        const payload = {
            XAVRequest: {
                AddressKeyFormat: {
